...
public class App extends Application {
    ...
    public void onCreate() {
		...
		BfdAgent.Config config = BfdAgent.getConfigInstance(mAppApplication);
		config.setAppkey("afdssdfasdfas").setHost("172.24.5.45:8966").setRecHost("172.24.5.45:8966");
		BfdAgent.onInit(config);
